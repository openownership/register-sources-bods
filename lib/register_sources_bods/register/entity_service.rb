...
module RegisterSourcesBods
    module Register
        class EntityService
            def initialize(entity_query_builder: EntityQueryBuilder.new, statement_repository:)
            ...
            def search(search_params, page: 1, per_page: 10)
                ...
                statements = statement_repository.search(query, aggs: aggs, page: page, per_page: per_page)
